        ...
        <div class="flex items-center justify-between flex-wrap bg-black text-white px-6 py-4">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-md lg:flex-grow">
                    <a href="#" class="block mt-4 lg:inline-block lg:mt-0 mr-4 border px-6 py-1 rounded hover:text-black hover:bg-white"><?php echo e(config('app.name')); ?></a>
                </div>
            </div>
...
<?php /**PATH /home/adame/Documents/work/kalbam/resources/views/welcome.blade.php ENDPATH**/ ?>